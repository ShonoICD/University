...
{  
    ...
    {
        GetHeaderCSV(ina219.ReadBusVoltage(), ina219.ReadCurrent(), ina219.ReadPower())
    ...
    (
        callback: _ =>
        {
            dataReadings.Add(GetRecordCSV(DateTimeOffset.Now, ina219.ReadBusVoltage(), ina219.ReadCurrent(), ina219.ReadPower()));
        },
